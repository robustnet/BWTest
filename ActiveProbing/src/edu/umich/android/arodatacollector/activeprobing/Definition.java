...
public class Definition {
	...
	public static final int THROUGHPUT_UP_SEGMENT_SIZE = 1357;
	public static final String UPLINK_FINISH_MSG = "*#*";
	
	// data limitation
	public static final int UP_DATA_LIMIT_BYTE = 1*(int)Math.pow(2, 10)*(int)Math.pow(2, 10); // uplink limitation (1 MB)
